#!/usr/bin/env bash
# ==============================================================================
# ZBridge Debug Tool (zb-debug-phone.sh)
# Role: Stops the background service on the phone and runs a DEBUG VERSION
#       of the listener loop to verify IP handling and handshake logic.
# ==============================================================================
